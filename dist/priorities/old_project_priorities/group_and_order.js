export function group_priorities_by_project(project_priorities) {
  const priorities_by_project = {};
...
export function order_priorities_by_project(priorities_by_project) {
  const projects_by_start_ms = [];
  ...
  projects_by_start_ms.sort((a, b) => {
    return a.start_ms < b.start_ms ? -1 : a.start_ms > b.start_ms ? 1 : a.project_id < b.project_id ? -1 : 1;
  });
