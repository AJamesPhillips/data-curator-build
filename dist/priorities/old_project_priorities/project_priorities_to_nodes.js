import {x, calc_width, project_priority_y, project_priority_height} from "../../canvas/display.js";
export function convert_project_priorities_to_nodes(args) {
...
function get_next_event(events, project_priority_id) {
  const index = events.findIndex(({id}) => id === project_priority_id);
  if (index < 0)
    return void 0;
  return events[index + 1];
}
export function get_extent_of_content(priorities_by_project) {
