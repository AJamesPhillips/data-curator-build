...
function _StorageOptionsForm(props) {
  ...
  const create_base = user_id === void 0 ? void 0 : async function() {
  ...
  }), base_count > 0 && create_base && /* @__PURE__ */ h("hr", null), create_base && /* @__PURE__ */ h("div", null, /* @__PURE__ */ h("h4", null, "Create ", base_count ? "a new" : "your first", " base"), /* @__PURE__ */ h("input", {
    type: "text",
