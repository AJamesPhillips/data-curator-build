import {handleIncomingRedirect} from "../../../../snowpack/pkg/@inrupt/solid-client-authn-browser.js";
import {CLIENT_NAME} from "../../../constants.js";
const LOCAL_STORAGE_KEY__SOLID_SESSION_RESTORE_URL = "solid_session_restore_url";
export function start_login(session, oidcIssuer) {
...
export async function correct_path() {
  ...
  if (!url)
    return console.log("`correct_path` has no url");
