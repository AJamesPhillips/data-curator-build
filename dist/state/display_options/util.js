export function derive_validity_filter(validity_filter) {
  const derived_validity_filter = {
...
export function derive_certainty_formatting(certainty_formatting) {
  const derived_certainty_formatting = {
