...
} from "../../shared/counterfactuals/convert_VAP_sets_to_visual_VAP_sets.js";
...
function _WComponentCounterfactualForm(props) {
  ...
  const counterfactual_VAP_set = target_VAP_set ? clean_VAP_set_for_counterfactual(target_VAP_set, target_VAP_id) : void 0;
  ...
  }))), target_wcomponent && counterfactual_VAP_set && /* @__PURE__ */ h("p", null, /* @__PURE__ */ h("span", {
    className: "description_label"
  ...
  }), !counterfactual_VAP_set && counterfactual_active_for_current_knowledge_view && /* @__PURE__ */ h("span", {
