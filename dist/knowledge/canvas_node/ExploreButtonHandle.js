...
function _ExploreButtonHandle(props) {
  ...
  if (!kvwc && (props.presenting || !props.presenting && !is_highlighted))
    return null;
  ...
  const class_name = `node_handle explore ` + (kvwc ? " has_nested_knowledge_view " : "") + (current_but_no_parent ? " current_but_no_parent " : "");
