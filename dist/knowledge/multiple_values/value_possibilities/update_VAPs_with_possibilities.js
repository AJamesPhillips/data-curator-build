...
import {get_value_possibilities_by_value} from "./get_value_possibilities_by_value.js";
export function update_VAPs_with_possibilities(initial_values_and_prediction_sets, maybe_value_possibilities) {
...
function run_tests() {
  ...
  let result = update_VAPs_with_possibilities(void 0, void 0);
  test(result, void 0, "Undefined initial VAPs returns undefined");
  result = update_VAPs_with_possibilities(void 0, value_possibilities);
  test(result, void 0, "Undefined initial VAPs returns undefined");
  result = update_VAPs_with_possibilities([], value_possibilities);
  test(result, [], "Empty initial VAPs returns empty");
  result = update_VAPs_with_possibilities(initial_values_and_prediction_sets, void 0);
