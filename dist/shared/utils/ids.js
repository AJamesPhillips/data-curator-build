function get_new_id() {
  return (parseInt(Math.random().toString().slice(2)) + 1e5).toString();
}
...
export const is_perception_id = (id) => !!id && perception_id_regex.test(id);
...
export const is_prediction_id = (id) => !!id && prediction_id_regex.test(id);
...
export const is_wc_knowledge_view_id = (id) => !!id && wc_knowledge_view_id_regex.test(id);
