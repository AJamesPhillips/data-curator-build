      ...
      input.on('data', data => {
        if (this._input !== null && data.length !== 0) {
          ...
          if (this._pendingBuffer) {
            data = Buffer$4.concat([this._pendingBuffer, data]);
            this._pendingBuffer = null;
          }
...
export { BlankNode, DataFactory, DefaultGraph, N3Lexer as Lexer, Literal, NamedNode, N3Parser as Parser, Quad, N3Store as Store, N3StreamParser as StreamParser, N3StreamWriter as StreamWriter, Term, Quad as Triple, N3Util as Util, Variable, N3Writer as Writer, termFromId, termToId };
