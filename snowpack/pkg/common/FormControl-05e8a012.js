import { e as _objectWithoutProperties, _ as _extends } from './withStyles-db69868f.js';
...
var Typography = /*#__PURE__*/k(function Typography(props, ref) {
...
var FormControlContext = B();

function useFormControl() {
  return F(FormControlContext);
}
...
var FormControl = /*#__PURE__*/k(function FormControl(props, ref) {
  ...
  var _React$useState = l(function () {
    ...
    if (children) {
      N.forEach(children, function (child) {
  ...
  var _React$useState2 = l(function () {
    // We need to iterate through the children and find the Input in order
    // to fully support server-side rendering.
  ...
  var onFilled = A(function () {
    setFilled(true);
  }, []);
  var onEmpty = A(function () {
    setFilled(false);
  }, []);
  var childContext = {
...
var FormControl$1 = withStyles(styles$1, {
  name: 'MuiFormControl'
})(FormControl);
