...
var useIsomorphicLayoutEffect = typeof window !== 'undefined' && typeof window.document !== 'undefined' && typeof window.document.createElement !== 'undefined' ? h : y;
...
_ref) {
  ...
  return function wrapWithConnect(WrappedComponent) {
    ...
    var usePureOnlyMemo = pure ? d : function (callback) {
      return callback();
    };

    function ConnectFunction(props) {
      var _useMemo = d(function () {
      ...
      var childPropsSelector = d(function () {
        // The child props selector needs the store reference as an input.
        // Re-create this selector whenever the store changes.
        return createChildSelector(store);
      }, [store]);

      var _useMemo2 = d(function () {
      ...
      var overriddenContextValue = d(function () {
      ...
      var _useReducer = p(storeStateUpdatesReducer, EMPTY_ARRAY, initStateUpdates),
      ...
      var lastChildProps = s();
      var lastWrapperProps = s(wrapperProps);
      var childPropsFromStoreUpdate = s();
      var renderIsScheduled = s(false);
      ...
      var renderedWrappedComponent = d(function () {
